...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3>说明：</h3><br>`,15),b=e("br",null,null,-1),m=e("br",null,null,-1),h=e("br",null,null,-1),g=e("h2",{id:"接收消息",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#接收消息","aria-hidden":"true"},"#"),n(" 接收消息")],-1),p=i(`<h3 id="接收所有消息" tabindex="-1"><a class="header-anchor" href="#接收所有消息" aria-hidden="true">#</a> 接收所有消息</h3><div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>bot.MessageReceived.OfType&lt;MessageReceiverBase&gt;().Subscribe(x =&gt;
{
    //能接收到所有消息和事件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="事件消息" tabindex="-1"><a class="header-anchor" href="#事件消息" aria-hidden="true">#</a> 事件消息</h3>`,7),f={href:"/ShamrockCore/doc/api/message.html#%E6%8E%A5%E6%94%B6%E6%B6%88%E6%81%AF",target:"_blank",rel:"noopener noreferrer"},x=i(`<div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code> bot.EventReceived.OfType&lt;MessageReceiverBase&gt;().Subscribe(x =&gt;
 {
     //能接收到所有消息和事件
     Console.WriteLine(x.ToJsonStr());
 });
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function w(k,_){const a=s("RouterLink"),r=s("ExternalLinkIcon");return t(),c("div",null,[u,n("Host：必填，纯IP地址，请勿带协议前缀如：http "),b,n("WsPort：必填，正向/反向ws端口 "),m,n("http_port：必填，http接口端口 "),h,n("token：选填，建议公网使用token "),g,e("p",null,[d(a,{to:"/api/event.html#%E4%BA%8B%E4%BB%B6%E7%9B%91%E5%90%AC%E8%AF%B4%E6%98%8E"},{default:o(()=>[n("更多")]),_:1})]),p,e("p",null,[e("a",f,[n("更多"),d(r)])]),x])}const B=l(v,[["render",w],["__file","start.html.vue"]]);export{B as default};
