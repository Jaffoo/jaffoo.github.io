...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12);function o(b,m){return a(),d("div",null,[l,e("Host：必填，纯IP地址，请勿带协议前缀如：http "),t,e("websocket_port：必填，主动webscoket端口 "),c,e("http_port：必填，http接口端口 "),u,e("token：选填，建议公网使用token "),v])}const g=s(r,[["render",o],["__file","start.html.vue"]]);export{g as default};
