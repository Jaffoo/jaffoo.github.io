import{_ as t,o as e,c as d,e as n}from"./app-11lmL9qc.js";const r={},s=n(`<h2 id="事件监听说明" tabindex="-1"><a class="header-anchor" href="#事件监听说明" aria-hidden="true">#</a> 事件监听说明</h2><p>以下所有事件都可以有两种方法监听，你只需要选择其中一个就行。</p><div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>bot.EventReceived.OfType&lt;EventBase&gt;().Subscribe(async msg =&gt;
{
