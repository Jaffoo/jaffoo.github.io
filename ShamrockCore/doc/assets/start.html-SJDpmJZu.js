...
using Bot bot = new(config);
await bot.Start();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3>说明：</h3><br>`,13),v=e("br",null,null,-1),b=e("br",null,null,-1),h=e("br",null,null,-1),m=e("br",null,null,-1),g=e("h2",{id:"接收消息",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#接收消息","aria-hidden":"true"},"#"),n(" 接收消息")],-1),p=e("h3",{id:"群消息",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#群消息","aria-hidden":"true"},"#"),n(" 群消息")],-1),k=i(`<div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>bot.MessageReceived.OfType&lt;GroupReceiver&gt;().Subscribe(async msg =&gt;{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="事件消息" tabindex="-1"><a class="header-anchor" href="#事件消息" aria-hidden="true">#</a> 事件消息</h3>`,6),_=i(`<div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>bot.EventReceived.OfType&lt;FriendAddEvent&gt;().Subscribe(async msg =&gt;{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function C(w,f){const s=r("RouterLink");return o(),c("div",null,[u,n("Host：必填，纯IP地址，请勿带协议前缀如：http "),v,n("websocket_port：必填，主动webscoket端口 "),b,n("http_port：必填，http接口端口 "),h,n("token：选填，建议公网使用token "),m,n("passive_websocket_port：选填，默认值6051 "),g,p,e("p",null,[a(s,{to:"/api/event.html#%E4%BA%8B%E4%BB%B6%E7%9B%91%E5%90%AC%E8%AF%B4%E6%98%8E"},{default:t(()=>[n("更多")]),_:1})]),k,e("p",null,[a(s,{to:"/api/message.html#%E6%8E%A5%E6%94%B6%E6%B6%88%E6%81%AF"},{default:t(()=>[n("更多")]),_:1})]),_])}const S=d(l,[["render",C],["__file","start.html.vue"]]);export{S as default};
