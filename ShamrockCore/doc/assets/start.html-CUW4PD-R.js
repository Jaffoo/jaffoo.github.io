import{_ as t,r,o,c,b as n,a as e,d as a,w as d,e as s}from"./app-_7ZXjjn1.js";const l={},u=s(`<h2 id="nuget安装" tabindex="-1"><a class="header-anchor" href="#nuget安装" aria-hidden="true">#</a> Nuget安装</h2><p>Nuget搜索ShamrockCore即可下载使用，同时，你可能还需要安装Manganese和System.Reactive.Linq。</p><h3 id="可能需要的命名空间如下" tabindex="-1"><a class="header-anchor" href="#可能需要的命名空间如下" aria-hidden="true">#</a> 可能需要的命名空间如下</h3><details><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>using Manganese.Text;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3>说明：</h3><br>`,13),v=e("br",null,null,-1),b=e("br",null,null,-1),h=e("br",null,null,-1),m=e("h2",{id:"接收消息",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#接收消息","aria-hidden":"true"},"#"),n(" 接收消息")],-1),g=e("h3",{id:"群消息",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#群消息","aria-hidden":"true"},"#"),n(" 群消息")],-1),p=s(`<div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>bot.MessageReceived.OfType&lt;GroupReceiver&gt;().Subscribe(async msg =&gt;{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="事件消息" tabindex="-1"><a class="header-anchor" href="#事件消息" aria-hidden="true">#</a> 事件消息</h3>`,6),k=s(`<div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>bot.EventReceived.OfType&lt;FriendAddEvent&gt;().Subscribe(async msg =&gt;{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function w(C,_){const i=r("RouterLink");return o(),c("div",null,[u,n("Host：必填，纯IP地址，请勿带协议前缀如：http "),v,n("WsPort：必填，正向/反向ws端口 "),b,n("http_port：必填，http接口端口 "),h,n("token：选填，建议公网使用token "),m,g,e("p",null,[a(i,{to:"/api/event.html#%E4%BA%8B%E4%BB%B6%E7%9B%91%E5%90%AC%E8%AF%B4%E6%98%8E"},{default:d(()=>[n("更多")]),_:1})]),p,e("p",null,[a(i,{to:"/api/message.html#%E6%8E%A5%E6%94%B6%E6%B6%88%E6%81%AF"},{default:d(()=>[n("更多")]),_:1})]),k])}const x=t(l,[["render",w],["__file","start.html.vue"]]);export{x as default};
